            ...
            <form action="{{route('tambahkaryawan')}}" method="POST">
                ...
                <fieldset >
                  ...
                  <div class="mb-3">
                    ...
                    <input name="nama_karyawan" type="text" id="disabledTextInput" class="form-control" placeholder="Nama" minlength="5" maxlength="20">
                  </div>
                  <div class="mb-3">
                    <label for="disabledSelect" class="form-label">Umur</label>
                    <select id="disabledSelect" class="form-select" name="umur_karyawan">
                      <?php for ($i = 21; $i <= 90; $i++) : ?>
                  ...
                  <div class="mb-3">
                    ...
                    <input name="alamat_karyawan" type="text" id="disabledTextInput" class="form-control" placeholder="Alamat" minlength="10" maxlength="40">
                  </div>
                  <div class="mb-3">
                    <label for="disabledTextInput" class="form-label">No. Telepon</label>
                    <input name="telepon_karyawan" type="text" id="disabledTextInput" class="form-control" placeholder="08xxxxxxxxx" minlength="9" maxlength="12">
                  </div>
